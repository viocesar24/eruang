...
$routes->post('peminjaman/end/(:segment)', [Peminjaman::class, 'end']);
$routes->post('peminjaman/end', [Peminjaman::class, 'end']);
$routes->get('peminjaman/end/(:segment)', [Peminjaman::class, 'end']);
$routes->get('peminjaman/end', [Peminjaman::class, 'end']);
