...
<section>
    <div class="card bg-body-tertiary">
        <div class="card-header text-center">
            <h2>
                <?= esc($title) ?>
                <?php if (session()->has('pegawai_id_user')): ?>
                    <h2>
        ...
        <div class="card-body">
            ...
            <div class="container table-responsive px-3 py-3 px-md-3 text-center text-lg-start">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <label class="input-group-text" for="input00">ID
                                                                        Peminjaman</label>
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <select name="id_pegawai" class="form-select"
                                                                        ...
                                                                        <option name="id_pegawai"
                                                                            ...
                                                                            selected>
                                                                            <?= esc($peminjaman_item['nama_pegawai']) ?></option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <select name="id_ruangan" class="form-select"
                                                                        ...
                                                                        <option name="id_ruangan"
                                                                            ...
                                                                            selected>
                                                                            <?= esc($peminjaman_item['nama_ruangan']) ?></option>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center">
                                                                ...
                                                                <input type="hidden" class="form-control text-center"
                                                                    ...
                                                                    name="id" value="<?= esc($peminjaman_item['id']) ?>" readonly>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                                                    data-bs-dismiss="modal">Tutup</button>
